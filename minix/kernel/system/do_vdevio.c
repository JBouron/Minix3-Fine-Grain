...
int do_vdevio(struct proc * caller, message * m_ptr)
{
	...
	char vdevio_buf[VDEVIO_BUF_SIZE];      
	pvb_pair_t * const pvb = (pvb_pair_t *) vdevio_buf;           
	pvw_pair_t * const pvw = (pvw_pair_t *) vdevio_buf;      
	pvl_pair_t * const pvl = (pvl_pair_t *) vdevio_buf;     
