...
/* Some canaries to indicate the end of some event since the BKL is no more. */
#define KTRACE_KERNEL_CALL_END (KTRACE_EVENT_LOW+60)
#define KTRACE_IPC_END (KTRACE_EVENT_LOW+61)

#define KTRACE_EVENT_HIGH KTRACE_BKL_RELEASE
#define KTRACE_NUM_KERNEL_CALLS ((KTRACE_SYS_PADCONF-KTRACE_SYS_FORK)+1)
